...
ANGLE_FILTER_MIN_LINES = 5 
LINES_FILTER_MIN_LINES = 6        # skip angle filter when fewer than this many lines (too little data to cluster)
LENGTH_FRACTION = 0.88          # lower floor: drop lines shorter than this fraction of the median length
